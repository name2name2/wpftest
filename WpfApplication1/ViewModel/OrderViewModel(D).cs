...
namespace WpfApplication1.ViewModel
{
    public class OrderViewModel : INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        public DateTime DeliveryDate
        {
            ...
            set { _order.DeliveryDate = value; this.NotifyPropertyChanged("DeliveryDate"); }
        }
        ...
        //會被加入最下方的PropertyChanged event 應該是在有property變動的時候會通知PropertyChanged event 
        //裡的每個東西  而這個方法因未被通知到了所以也會執行  
        //然後若total有關的變數值有更新  這個方法會把total更新
        //然後會再檢測一次所有值的合法性
        //接著更新Command 的 CanExecute的狀態以確定Command是否可執行
        ...
        //EventHandler    &    DelegateCommand with   CanSave Save Onsaved
        //register DataEventArgs<OrderViewModel> to EventHandler
        #region SaveOrder 
        ...
        {
            // Save the order here.
            Console.WriteLine(String.Format(CultureInfo.InvariantCulture,"{0} saved"));
        ...
        public string this[string columnName]
        {
            get
            {
                ...
                {
                    return this.errors[columnName];//原來是字典用法...!!
                }
                return null;
            }
            set { this.errors[columnName] = value; }//應該是設錯誤情況相對應的錯誤字串
        }
        ...
        // PropertyChanged event 和他的代理人方法 NotifyPropertyChanged
